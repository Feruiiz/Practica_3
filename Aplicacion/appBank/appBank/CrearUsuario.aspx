<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CrearUsuario.aspx.cs" Inherits="appBank.CrearUsuario" %>
...
<body background="./imagenes/CrearUsuario.jpg">
    <form id="form3" runat="server">
        <h2>CREAR USUARIO</h2>
            ...
            <asp:Label ID="Error3" runat="server" Text="Debe Contener al Menos 1 digito y no ser mayor a 12 caracteres" cssclass="label" ForeColor="White"></asp:Label> 
            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server"    
               ...
               ValidationExpression="^[a-zA-Z0-9'@&#.\s]{2,12}$" ForeColor="White" />
            <asp:TextBox class ="cajadeTexto" ID="correo" runat="server" placeholder ="Correo electronico" required TextMode="Email"></asp:TextBox>
            <asp:Label ID="Error" runat="server" cssclass="labels" ForeColor="Red"></asp:Label> 
            ...
            <asp:RegularExpressionValidator ID="RegExp1" runat="server"    
               ...
               ValidationExpression="^[a-zA-Z0-9'@&#.\s]{8}$" ForeColor="White" />
